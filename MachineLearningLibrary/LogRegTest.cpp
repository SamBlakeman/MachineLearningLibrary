...
void LogRegTest::Test1()
{
    ...
    // Accuracy
    double Accuracy = logr.CalculatePerformance(XTrain, YTrain);
    cout << "Training Accuracy:\n" << Accuracy << endl;
    
    Accuracy = logr.CalculatePerformance(XTest, YTest);
    cout << "Test Accuracy:\n" << Accuracy << endl;
...
void LogRegTest::Test2()
{
    ...
    double Accuracy = lgr.CalculatePerformance(XTest, YTest);
    cout << "\nAccuracy:\n" << Accuracy << endl;
